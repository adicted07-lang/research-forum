...
export async function generateMetadata({ searchParams }: SearchPageProps): Promise<Metadata> {
  ...
  const q = params.q || "";
  return {
    title: q ? `"${q}" — Search — The Intellectual Exchange` : "Search — The Intellectual Exchange",
    description: "Search across questions, listings, articles, researchers, and jobs on The Intellectual Exchange.",
    ...
    <div className="max-w-[1280px] mx-auto px-6 py-6">
      ...
      {!query ? (
        <div className="text-center py-20 text-text-tertiary">
          ...
          <p className="text-lg font-medium">Search The Intellectual Exchange</p>
